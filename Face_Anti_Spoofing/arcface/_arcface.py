...
def main():
    ArcFace.APP_ID = b"12X1RddQqxT4qDfYQRNYQw57nJt8mY2NgDSQeCGgyqSo"
    ArcFace.SDK_KEY = b"HjohsoNHiQYxqoLWpZ7b29n7DWErAWVopp5p7MxP5pF1"

    arcface = ArcFace(ArcFace.IMAGE_MODE)
    # image = cv.imread(r"20190905160950.jpg")
    image = cv.imread('2020302171024-袁长玲.png')
    # cv.waitKey(1000)
